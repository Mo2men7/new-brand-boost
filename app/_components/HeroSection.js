...
export default function HeroSection() {
  return (
    <section>
      <div className="relative w-full h-screen flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-0 lg:justify-between px-10 z-10">
        {/* Video Background */}
        <video
          autoPlay
          loop
        ...
        {/* Left Side - Text */}
        <div className="text-white max-w-lg text-center lg:text-start">
        ...
        <div className="">
          <Image
            ...
            width={400}
            height={400}
            className="w-[150px] md:w-[400] sm:w-[300px] xs:w-[200px]"
          />
        </div>
      </div>
    </section>
